  ...
  return (
    <div className="max-w-3xl mx-auto p-8 py-16">
      <div className="flex flex-col sm:flex-row sm:justify-between mb-16">
        <div className="flex flex-col">
          <div className="flex items-start gap-5 mb-4">
            <Profile />
            <div className="flex flex-col">
              <h1 className="text-xl font-bold text-accent-teal">
                Curriculum Vitae
              </h1>
              <p className="text-muted-foreground mb-4">Jaka Krajnc</p>
      ...
      <div className="border-b border-border pb-6 mb-10">
        <h1 className="text-xl font-bold mb-2">Jaka Krajnc</h1>
        <p className="text-muted-foreground">
          Detail-oriented Full Stack Developer dedicated to building
          high-quality applications.
        </p>
        <p className="text-muted-foreground">Maribor, SLO • jaka@krajnc.cc</p>
      </div>

      <div className="mb-10">
        <h2 className="text-xl font-bold mb-4">About</h2>
        <p className="text-base">
          Dedicated Full Stack Developer with a passion for clean code and
          user-centered design. 8+ years of experience effectively building
          scalable web applications and leading development teams. Confident in
          ability to architect solutions that balance technical excellence with
          business requirements. Committed to continuous learning and
      ...
      <div className="mb-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-base italic mb-4">
            Lead developer for the company's flagship SaaS platform serving 500+
            enterprise clients.
          </p>
          <ul className="list-disc pl-5 space-y-2 text-base">
            <li>
              Spearheaded migration from monolith to microservices architecture,
              improving deployment frequency by 300%.
            </li>
            <li>
              Implemented comprehensive testing strategy that reduced production
              bugs by 75%.
            </li>
            <li>
            ...
            <li>
              Designed and implemented RESTful APIs that processed over 2M
              requests daily.
            </li>
          </ul>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="text-base italic mb-4">
            Developed and maintained B2B marketing automation tools used by
            mid-market companies.
          </p>
          <ul className="list-disc pl-5 space-y-2 text-base">
            <li>
              Built responsive front-end interfaces using React that improved
              user satisfaction scores by 45%.
            </li>
            <li>
              Designed and implemented RESTful APIs that processed over 1M
              requests daily.
            </li>
            <li>
              Optimized database queries that reduced average response time from
              1.2s to 200ms.
            </li>
            <li>
        ...
        <div>
          ...
          <p className="text-base italic mb-4">
            Developed websites and web applications for small to medium-sized
            businesses.
          </p>
          <ul className="list-disc pl-5 space-y-2 text-base">
            <li>
              Built and maintained over 20 client websites using responsive
              design principles.
            </li>
            <li>
              Implemented e-commerce solutions using WooCommerce and custom PHP
              solutions.
            </li>
            <li>
              Collaborated with design team to translate mockups into functional
              websites.
            </li>
          </ul>
        </div>
